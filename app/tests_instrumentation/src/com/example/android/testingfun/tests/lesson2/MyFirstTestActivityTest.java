...
public class MyFirstTestActivityTest extends ActivityInstrumentationTestCase2<MyFirstTestActivity> {
    ...
    /**
     * Test if your test fixture has been set up correctly. You should always
     * implement a test that checks the correct setup of your test fixture. If
     * this tests fails all other tests are likely to fail as well.
     */
    ...
    public void testMyFirstTestTextView_labelText() {
        // It is good practice to read the string from your resources in order
        // to not break
        // multiple tests when a string changes.
        final String expected = mFirstTestActivity.getString(R.string.my_first_test);
        final String actual = mFirstTestText.getText()
                                            .toString();
